...
topics_lst = ["shark+australia", "beach+jellyfish+australia", "beach+rip+currents", "beach+surfing+australia", "surfing+guide", "surfing+events"]
for topic in topics_lst[:]: 
    news_row_dict = {}
    
    q_str = qInTitle_str = topic
...
#                 print("response_dict['articles'] = ", response_dict['articles'])
                ...
                for article_dict in response_dict['articles']:
                    ...
                    news_row_dict['description'] = article_dict['description']
